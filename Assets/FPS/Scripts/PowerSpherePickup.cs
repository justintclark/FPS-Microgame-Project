...
//As this is for hard mode, hard mode's difficulty scales the enemies' damage by 1.5x. Enemies' health pools are also increased by 2.5x. Boss health pools are increased significantly. 
//My intent was to also increase the player's damage output, but the way this project is coded doesn't make it very clear how exactly to influence the damage of each of the projectiles. 
